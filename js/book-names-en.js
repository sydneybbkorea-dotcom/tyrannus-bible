// book-names-en.js — 한국어 책 이름 → KJV 영문 책 이름 매핑
var BOOK_EN = {
  '창세기':'Genesis','출애굽기':'Exodus','레위기':'Leviticus','민수기':'Numbers','신명기':'Deuteronomy',
  '여호수아기':'Joshua','사사기':'Judges','룻기':'Ruth','사무엘기상':'1 Samuel','사무엘기하':'2 Samuel',
  '열왕기상':'1 Kings','열왕기하':'2 Kings','역대기상':'1 Chronicles','역대기하':'2 Chronicles',
  '에스라':'Ezra','느헤미야기':'Nehemiah','에스더기':'Esther','욥기':'Job','시편':'Psalms',
  '잠언':'Proverbs','전도서':'Ecclesiastes','솔로몬의아가':'Song of Solomon',
  '이사야서':'Isaiah','예레미야서':'Jeremiah','예레미야애가':'Lamentations',
  '에스겔서':'Ezekiel','다니엘서':'Daniel','호세아':'Hosea','요엘':'Joel','아모스':'Amos',
