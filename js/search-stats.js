...
function _schRenderStats(results){
  ...
  h+='<span class="adv-stat-num">'+totalOcc+'</span> '+t('sch.occ')+' · ';
  h+='<span class="adv-stat-num">'+vSet.size+'</span> '+t('sch.v')+' · ';
  h+='<span class="adv-stat-num">'+chSet.size+'</span> '+t('sch.ch')+' · ';
  h+='<span class="adv-stat-num">'+bkSet.size+'</span> '+t('sch.bk')+'</div>';
  h+='<div class="adv-bar-wrap"><div class="adv-bar">';
  h+='<div class="adv-bar-ot" style="width:'+otPct+'%"></div></div>';
  h+='<div class="adv-bar-labels"><span>'+t('ot')+' '+otV+'</span>';
  h+='<span>'+t('nt')+' '+ntV+'</span></div></div>';
  area.innerHTML=h;
}
