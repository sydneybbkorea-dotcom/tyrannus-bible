...
window.restore = function restore(){
  try {
    ...
    if(d.sharedByMe) S.sharedByMe=d.sharedByMe;
    if(d.sharedWithMe) S.sharedWithMe=d.sharedWithMe;
  } catch(e){}
}
